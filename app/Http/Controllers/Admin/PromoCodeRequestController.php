            ...
            try {
                ...
                if (! $checkoutUrl) {
                    ...
                    Mail::raw(
                        ...
                        "Votre demande de validation FEA vient d'être approuvée. Pour finaliser votre inscription à UNICOACH au tarif diplômé (20€ HTVA / mois), veuillez effectuer votre paiement via le lien suivant :\n\n" .
                        $checkoutUrl . "\n\n" .
                        ...
                        function ($message) use ($user) {
                            $message->to($user->email, $user->first_name . ' ' . $user->last_name)
                                ->subject('Votre lien de paiement UNICOACH (validation FEA approuvée)');
                        }
                    );
                }
