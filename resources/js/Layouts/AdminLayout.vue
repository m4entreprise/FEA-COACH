                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            <div class="flex shrink-0 items-center">
                                <Link :href="route('admin.coaches.index')">
                                    <ApplicationLogo
                                    ...
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            ...
                                            >
                                                ...
                                                <span class="ml-2 text-xs bg-blue-100 text-blue-800 px-2 py-0.5 rounded dark:bg-blue-900 dark:text-blue-200">Admin</span>
