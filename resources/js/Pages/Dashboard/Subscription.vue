            ...
            <div class="mx-auto max-w-4xl space-y-6 sm:px-6 lg:px-8">
                ...
                <div class="overflow-hidden rounded-2xl bg-gradient-to-br from-white to-indigo-50 shadow-xl dark:from-gray-800 dark:to-indigo-900/20 border border-indigo-200/50 dark:border-indigo-500/30 backdrop-blur-xl">
                    <div class="p-8">
                        ...
                        <div class="relative bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl p-8 text-white mb-6 overflow-hidden">
                            <!-- Promotional Badge - Top Right -->
                            <div class="absolute -top-2 -right-2 bg-gradient-to-br from-yellow-400 via-orange-500 to-red-500 text-white px-6 py-3 rounded-bl-2xl rounded-tr-2xl shadow-2xl transform rotate-2 animate-pulse">
                                <div class="flex items-center gap-2">
                                    <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                    </svg>
                                    <span class="font-bold text-lg">PROMO FEA</span>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                <div class="flex items-baseline gap-3 mb-3">
                                    <div class="flex items-baseline gap-2">
                                        <span class="text-2xl text-indigo-200 line-through opacity-75">40€</span>
                                        <span class="text-6xl font-bold">30€</span>
                                    </div>
                                    <span class="text-xl text-indigo-100">HTVA/mois</span>
                                </div>
                                <div class="bg-gradient-to-r from-yellow-400 to-orange-500 rounded-xl px-5 py-3 inline-flex items-center gap-3 shadow-lg transform hover:scale-105 transition-transform duration-200">
                                    <svg class="h-6 w-6 text-white animate-bounce" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M5 2a1 1 0 011 1v1h1a1 1 0 010 2H6v1a1 1 0 01-2 0V6H3a1 1 0 010-2h1V3a1 1 0 011-1zm0 10a1 1 0 011 1v1h1a1 1 0 110 2H6v1a1 1 0 11-2 0v-1H3a1 1 0 110-2h1v-1a1 1 0 011-1zM12 2a1 1 0 01.967.744L14.146 7.2 17.5 9.134a1 1 0 010 1.732l-3.354 1.935-1.18 4.455a1 1 0 01-1.933 0L9.854 12.8 6.5 10.866a1 1 0 010-1.732l3.354-1.935 1.18-4.455A1 1 0 0112 2z" clip-rule="evenodd"/>
                                    </svg>
                                    <div>
                                        <p class="font-bold text-white text-base">
                                            Économisez 10€ HTVA/mois
                                        </p>
                                        <p class="text-sm text-white/90 font-semibold">
                                            Offert par Fitness Education Academy
                                        </p>
                                    </div>
                                </div>
                            </div>
