                            ...
                            <div class="flex items-start justify-between gap-6 mb-6">
                                <div>
                                    ...
                                    <div class="flex items-center gap-2 text-indigo-100">
                                        <span class="text-lg line-through opacity-60">30€</span>
                                        <span class="text-sm">Prix normal</span>
                                    </div>
                                </div>
                                
                                <div class="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl px-4 py-3 text-right">
                                    <p class="text-emerald-300 font-semibold text-sm mb-1">Partenariat</p>
                                    <p class="text-white font-bold text-base">Fitness Education Academy</p>
                                </div>
                            </div>
                            
                            <div class="bg-white/15 backdrop-blur-sm border border-white/20 rounded-lg px-5 py-3 mb-4">
                                <p class="text-white font-medium">
                                    💎 Bénéficiez d'une réduction permanente de <span class="font-bold">10€ HTVA/mois</span> grâce à l'intervention de Fitness Education Academy
                                </p>
                            </div>
