...
const previewPayload = () => ({
    ...
    method_title: form.method_title,
    method_subtitle: form.method_subtitle,
    method_step1_title: form.method_step1_title,
    method_step1_description: form.method_step1_description,
    method_step2_title: form.method_step2_title,
    ...
    transformations_subtitle: form.transformations_subtitle,
    final_cta_title: form.final_cta_title,
    final_cta_subtitle: form.final_cta_subtitle,
});
