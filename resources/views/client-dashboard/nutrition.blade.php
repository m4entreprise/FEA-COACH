...
@section('page-title', 'Programme alimentaire')
...
<div class="section-header">
  <h2 class="section-title">Programme alimentaire</h2>
  <p class="section-subtitle">Vos plans nutritionnels personnalisés</p>
</div>
...
<div class="documents-grid">
  ...
  @empty
    <div class="empty-state">
      ...
      <h3 class="empty-state-title">Aucun programme disponible</h3>
      <p class="empty-state-text">Votre coach n'a pas encore partagé de programme alimentaire.</p>
    </div>
  @endforelse
</div>
@endsection
