...
@section('page-title', 'Programme sportif')
...
<div class="section-header">
  <h2 class="section-title">Programme sportif</h2>
  <p class="section-subtitle">Vos programmes d'entraînement personnalisés</p>
</div>
...
<div class="documents-grid">
  ...
  @empty
    <div class="empty-state">
      ...
      <p class="empty-state-text">Votre coach n'a pas encore partagé de programme sportif.</p>
    </div>
  @endforelse
</div>
@endsection
