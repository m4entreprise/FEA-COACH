                    ...
                    <div class="space-y-4">
                        ...
                        <div class="rounded-3xl border border-white/10 bg-white/5 p-5 space-y-4 text-sm text-white/80">
                            ...
                            <div>
                                ...
                                <a href="#tarifs" class="mt-2 inline-flex items-center justify-center text-center gap-2 rounded-full border border-white/40 px-4 py-2 text-sm font-semibold hover:bg-white hover:text-primary transition-all">
