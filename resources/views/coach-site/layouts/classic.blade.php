                ...
                <div class="grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] gap-8">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <input
                                        ...
                                        autocomplete="name"
                                        value="{{ old('name') }}"
                                        class="peer block w-full rounded-xl border border-white/20 bg-white px-4 py-3 pl-11 text-gray-900 placeholder-gray-500 shadow-[0_10px_25px_rgba(0,0,0,0.15)] focus:border-white/80 focus:outline-none focus:ring-2 focus:ring-white/80"
                    ...
                    <div class="space-y-4">
                        ...
                        <textarea
                            ...
                            rows="6"
                            required
                            class="w-full rounded-2xl border border-white/25 bg-white px-4 py-4 text-base text-gray-900 placeholder-gray-500 shadow-[0_20px_45px_rgba(0,0,0,0.25)] focus:border-white/80 focus:outline-none focus:ring-2 focus:ring-white/80"
